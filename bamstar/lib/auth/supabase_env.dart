...
String get supabaseUrl =>
	dotenv.maybeGet('SUPABASE_URL') ?? dotenv.maybeGet('NEXT_PUBLIC_SUPABASE_URL') ?? '';
...
String get googleWebClientId =>
	dotenv.maybeGet('NEXT_PUBLIC_GOOGLE_WEB_CLIENT_ID') ?? dotenv.maybeGet('GOOGLE_WEB_CLIENT_ID') ?? '';
