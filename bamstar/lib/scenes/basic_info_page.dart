...
class _BasicInfoPageState extends State<BasicInfoPage> {
  ...
  final List<String> _loadedImageUrls =
      <String>[]; // Existing images from database
  ...
  Future<void> _saveBasicInfo() async {
    ...
    try {
      ...
      final basicInfo = BasicInfo(
        ...
        contactPhone: _phoneCtl.text.trim().isEmpty
            ? null
            : _phoneCtl.text.trim(),
        socialService: _selectedSns.isEmpty ? null : _selectedSns,
        socialHandle: _snsHandleCtl.text.trim().isEmpty
            ? null
            : _snsHandleCtl.text.trim(),
        bio: _introCtl.text.trim().isEmpty ? null : _introCtl.text.trim(),
      );

      // Save to database
      final success = await BasicInfoService.instance.saveBasicInfo(
        basicInfo,
        _photos,
      );
