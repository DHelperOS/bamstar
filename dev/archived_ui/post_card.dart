                    ...
                    children: [
                      if (!post.isAnonymous && post.authorAvatarUrl != null)
                        CircleAvatar(
                          ...
                          backgroundImage: avatarImageProviderFromUrl(
                            post.authorAvatarUrl,
                            width: (CommunitySizes.avatarBase).toInt(),
                            height: (CommunitySizes.avatarBase).toInt(),
                          ),
                        ),
                      if (post.isAnonymous && post.authorAvatarUrl != null)
                        ...
                        ClipOval(
                          child: ImageFiltered(
                            ...
                            child: Image(
                              image: avatarImageProviderFromUrl(
                                post.authorAvatarUrl,
                                width: (CommunitySizes.avatarBase).toInt(),
                                height: (CommunitySizes.avatarBase).toInt(),
                              ),
              ...
              children: [
                FutureBuilder<List<String>>(
                  ...
                  builder: (context, snap) {
                    final avatars =
                        (snap.hasData && (snap.data?.isNotEmpty == true))
                        ? snap.data!
